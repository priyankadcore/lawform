                ...
                <li> <img src="images/slider-img-1.jpg" alt="">
                    <div class="container">
                        ...
                        <div class="bnr-property">
                            ...
                            <hr>
                            <p>It takes diff'rent strokes to move the world. Till the one when the lady met this fellow and
                                they knew </p>
                            <a href="#." class="btn">contact agent</a> <a href="#." class="btn btn-1">more
                                details</a>
                        </div>
                    </div>
                </li>
                ...
                <li> <img src="images/slider-img-2.jpg" alt="">
                    <div class="container">
                        ...
                        <div class="bnr-property">
                            ...
                            <hr>
                            <p>It takes diff'rent strokes to move the world. Till the one when the lady met this fellow and
                                they knew. Till the one when the lady met this fellow and they knew </p>
                            <a href="#." class="btn">contact agent</a> <a href="#." class="btn btn-1">more
                                details</a>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <hr>
                    <p>Flatnin' the hills Someday the mountain might get ‘em but the law never will. And when the odds are
                        against him and their dangers work to do. You bet your life Speed Racer he will see it through.</p>
                    <a href="#." class="btn">get the realtor app</a>
                </div>
            </div>
        </div>
    </section>
