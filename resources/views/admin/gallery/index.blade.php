...
@section('content')
    <x-breadcrub pagetitle="Admin" subtitle="Gallery" title="Gallery Image" />
    <div class="container-fluid">
        <div class="top-header">
            <div>
                <h1>Media Gallery</h1>
                <p class="subtitle">Gallery and manage your images</p>
            </div>
        ...
        <section class="upload-section">
            ...
            <div class="search-container">
                ...
                <div class="search-count-container">
                    <div class="image-count" id="imageCount">{{ $gallerys->count() }} images</div>
                </div>
            </div>
        </section>
        ...
        <section class="gallery-section">
            <div class="gallery" id="imageGallery">
                @foreach ($gallerys as $upload)
                    <div class="image-card" data-id="{{ $upload->id }}" data-name="{{ $upload->filename }}">
                        <div class="image-preview-container">
                            <img src="{{ asset('storage/gallery/' . $upload->filename) }}" alt="{{ $upload->filename }}"
                                class="image-preview">
                        </div>
                        <div class="image-info">
                            ...
                            <div class="card-actions">
                                <button class="action-button copy-button"
                                    data-url="{{ asset('storage/gallery/' . $upload->filename) }}">
...
@section('scripts')
    ...
    <script>
        ...
        function uploadFile(file) {
            ...
            xhr.open('POST', '{{ route('admin.gallery.store') }}');
            xhr.send(formData);
        }
