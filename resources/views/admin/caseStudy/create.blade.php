            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div>
                            <h1 class="page-title mb-0">Create Case Study</h1>
                        </div>
                        <div>
                    ...
                    <div class="card-body">
                        ...
                        <form id="caseStudyForm" action="{{ route('admin.caseStudy.store') }}" method="POST"
                                       ...
                                       <div class="mb-3">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                                rows="4" placeholder="Write a compelling description that summarizes your Case Study post" required>{{ old('description') }}</textarea>
                                            @error('description')
                                                <div class="error-message">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        <button type="submit" class="btn btn-primary">
                                            <i class="fas fa-save me-1"></i> Save Case Study
                                        </button>
                                    </div>
                                </div>
                            </div>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#Case StudyForm').on('submit', function(e) {
                // Basic validation
