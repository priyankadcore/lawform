                                            ...
                                            <tr>
                                                ...
                                                <td class="action-btns">
                                                    <button class="btn btn-sm btn-outline-primary edit-page-btn"
                                                        ...
                                                        data-slug="{{ $page->slug }}" data-status="{{ $page->status }}"
            ...
            <form method="POST" enctype="multipart/form-data" id="editPageForm">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-black" id="editPageModalLabel">Edit Page</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="mb-3">
                                ...
                                <textarea name="meta_description" class="form-control" id="metaDescription" placeholder="Enter meta description"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="mb-3">
                                ...
                                <textarea name="og_description" class="form-control" id="ogDescription" placeholder="Enter OG description"></textarea>
                            </div>
                        </div>
                    </div>
...
@section('scripts')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const editPageForm = document.querySelector('#editPageModal form');
            ...
            editButtons.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    document.getElementById('metaDescription').value = this.dataset
                        .meta_description || '';
                    ...
                    editPageForm.action = `/admin/pages/${pageId}`;
                });
            });
        });
    </script>
